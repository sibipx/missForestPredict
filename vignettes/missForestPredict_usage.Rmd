...
Note that not all arguments to ranger function are supported. Arguments that should be adapted in function of the imputed variable (outcome for the ranger function) are not supported. Generic arguments that can be applied to all variables are supported (like: *num.trees, mtry, min.node.size, max.depth, replace,* ...)
