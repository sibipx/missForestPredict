...
The errors (MSE, NMSE) for x and y decreased. The missclasification error (MER) is 0 in both cases??? Note that we chose to set the `OOB_weights` parameter so that the errors of the last 2 variables are not taken into account when calculating the convergence criteria. 
