...
The errors (MSE, NMSE) for `Sepal.Length` and `Sepal.Width` decreased. The missclasification error (MER) for `Species` is 0 (if a variable does not have missing values, the error returned will be 0). 
