...
We consider the case when a date variable is kept in the dataframe for further reference. Such vriable does not need imputation, nor can be used as predictor.
